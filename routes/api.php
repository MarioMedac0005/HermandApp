...
Route::get('/search', [SearchController::class, 'index']); // Ruta publica para poder buscar bandas y hermandades.
    
/* Rutas protegidas sin restriccion de roles */
...
Route::middleware(['auth:sanctum', 'role:admin'])->group(function () {
    ...
    Route::get('/dashboard/count', [DashboardController::class, 'count']); // El usuario debe estar autenticado y tener el rol admin.
